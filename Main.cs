...
namespace Fractal
{
    public partial class Main : Control
    {
        ...
        private void SetupUI()
        {
            ...
            // Заголовок
            var title = new Label();
            title.Text = "Фрактал: Кривая Коха";
        ...
        private void SetupFractal()
        {
            ...
            float bottomY = GetViewport().GetVisibleRect().Size.Y - 100; // 100px от нижнего края
